...
symptoms:
  ...
  - >-
    Игра закрывается или вылетает после использования программ для обхода
    блокировок (например, GoodbyeDPI)
  - Отказ в доступе при попытке остановить службу WinDivert
causes:
  - >-
    Конфликт с фоновыми программами (GoodbyeDPI, Zapret, NZXT CAM, MSI
    Afterburner, Razer Cortex)
