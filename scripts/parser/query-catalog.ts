...
const groups: QueryGroup[] = [
  ...
  {
    name: 'home-appliances-washing',
    subjects: [
      'стиральная машина LG', 'стиральная машина Samsung', 'стиральная машина Bosch', 'стиральная машина Indesit',
      'стиральная машина Whirlpool', 'стиральная машина Electrolux', 'стиральная машина Candy', 'стиральная машина Hotpoint',
      'стиральная машина Haier', 'стиральная машина Midea', 'стиральная машина Xiaomi', 'стиральная машина Gorenje',
      'стиральная машина AEG', 'стиральная машина Siemens', 'стиральная машина Zanussi', 'стиральная машина Beko',
      'стиральная машина Ardo', 'стиральная машина Vestel', 'стиральная машина Hansa', 'стиральная машина Kaiser'
    ],
    intents: [
      'код ошибки исправить', 'не сливает воду решение', 'не отжимает решение', 'не включается решение',
      'течёт вода решение', 'шумит при отжиме решение', 'выдает ошибку исправить', 'не греет вода решение',
      'не блокирует люк решение', 'барабан не крутится исправить', 'ошибка на дисплее решение'
    ]
  },
  {
    name: 'home-appliances-fridge',
    subjects: [
      'холодильник LG', 'холодильник Samsung', 'холодильник Bosch', 'холодильник Indesit',
      'холодильник Atlant', 'холодильник Haier', 'холодильник Whirlpool', 'холодильник Hotpoint',
      'холодильник Beko', 'холодильник Sharp', 'холодильник Liebherr', 'холодильник Midea',
      'холодильник Electrolux', 'холодильник AEG', 'холодильник Vestel', 'холодильник Gorenje'
    ],
    intents: [
      'не морозит решение', 'течёт вода решение', 'шумит решение', 'не включается решение',
      'морозит слишком сильно исправить', 'не отключается компрессор исправить', 'ошибка на дисплее исправить',
      'свет внутри не работает исправить', 'код ошибки исправить'
    ]
  },
  {
    name: 'home-appliances-dishwasher',
    subjects: [
      'посудомоечная машина Bosch', 'посудомоечная машина Siemens', 'посудомоечная машина Electrolux',
      'посудомоечная машина Miele', 'посудомоечная машина Hansa', 'посудомоечная машина Candy',
      'посудомоечная машина Indesit', 'посудомоечная машина Hotpoint', 'посудомоечная машина Beko',
      'посудомоечная машина LG', 'посудомоечная машина Samsung', 'посудомоечная машина Whirlpool'
    ],
    intents: [
      'не моет посуду решение', 'не сливает воду исправить', 'не включается решение',
      'ошибка на дисплее исправить', 'течёт вода решение', 'шумит решение', 'сушит плохо исправить',
      'не набирает воду исправить', 'код ошибки исправить'
    ]
  },
  {
    name: 'home-appliances-microwave-oven',
    subjects: [
      'микроволновка LG', 'микроволновка Samsung', 'микроволновка Panasonic', 'микроволновка Sharp',
      'печь Bosch', 'печь Electrolux', 'печь Gorenje', 'микроволновка Xiaomi',
      'микроволновка Midea', 'духовка Hansa', 'духовка Kaiser', 'духовка Hotpoint'
    ],
    intents: [
      'не греет решение', 'искрит решение', 'не включается решение',
      'шумит решение', 'тарелка не крутится исправить', 'выбивает пробки исправить',
      'код ошибки исправить', 'не работает кнопка исправить'
    ]
  },
  {
    name: 'home-appliances-tv',
    subjects: [
      'телевизор LG', 'телевизор Samsung', 'телевизор Sony', 'телевизор Philips',
      'телевизор Xiaomi', 'телевизор Hisense', 'телевизор TCL', 'телевизор Panasonic',
      'телевизор Haier', 'телевизор Grundig', 'саундбар Samsung', 'саундбар LG',
      'саундбар Sony', 'саундбар JBL'
    ],
    intents: [
      'не включается решение', 'нет изображения исправить', 'нет звука исправить',
      'не видит пульт исправить', 'мигает экран исправить', 'не загружается смарт ТВ исправить',
      'ошибка подключения wifi исправить', 'тормозит интерфейс исправить',
      'полоса на экране исправить', 'битые пиксели исправить',
      'не отображается флешка исправить'
    ]
  },
  {
    name: 'home-appliances-ac',
    subjects: [
      'кондиционер LG', 'кондиционер Samsung', 'кондиционер Daikin', 'кондиционер Mitsubishi',
      'кондиционер Haier', 'кондиционер Gree', 'кондиционер Midea', 'кондиционер Ballu',
      'кондиционер Toshiba', 'кондиционер Panasonic', 'кондиционер Electrolux',
      'сплит-система Hisense', 'сплит-система TCL', 'обогреватель Ballu',
      'обогреватель Electrolux', 'обогреватель Timberk', 'тепловентилятор Xiaomi'
    ],
    intents: [
      'не включается решение', 'не охлаждает исправить', 'течёт вода исправить',
      'шумит решение', 'не реагирует на пульт исправить', 'код ошибки на дисплее исправить',
      'дует но не холодит исправить', 'выключается сам исправить',
      'не греет обогреватель исправить', 'пахнет горелым исправить'
    ]
  },
  {
    name: 'home-appliances-vacuum',
    subjects: [
      'робот-пылесос Xiaomi', 'робот-пылесос Roborock', 'робот-пылесос iRobot Roomba',
      'робот-пылесос Samsung', 'робот-пылесос LG', 'робот-пылесос Dreame',
      'робот-пылесос Tefal', 'робот-пылесос Okami', 'пылесос Karcher',
      'пылесос Dyson', 'пылесос Bosch', 'пылесос Samsung',
      'вертикальный пылесос Xiaomi', 'вертикальный пылесос Dyson',
      'робот-пылесос Polaris', 'робот-пылесос Kitfort'
    ],
    intents: [
      'не заряжается решение', 'не строит карту исправить', 'теряется в пространстве исправить',
      'не включается решение', 'плохо убирает исправить', 'ошибка подключения к wifi исправить',
      'застревает решение', 'не видит базу исправить', 'ошибка датчика исправить',
      'шумит сильнее обычного исправить'
    ]
  },
  {
    name: 'home-appliances-power-tools',
    subjects: [
      'шуруповёрт Makita', 'шуруповёрт Bosch', 'шуруповёрт Dewalt', 'шуруповёрт Metabo',
      'дрель Makita', 'дрель Bosch', 'перфоратор Makita', 'перфоратор Bosch',
      'болгарка Makita', 'болгарка Hitachi', 'лобзик Bosch', 'лобзик Makita',
      'аккумулятор Makita', 'аккумулятор Bosch', 'зарядное устройство Makita',
      'зарядное устройство Bosch', 'шлифмашина Makita', 'фрезер Bosch',
      'пила циркулярная Makita', 'электрорубанок Makita'
    ],
    intents: [
      'не включается решение', 'искрит щётки исправить', 'не крутится исправить',
      'не заряжается аккумулятор исправить', 'дымит решение', 'стучит решение',
      'патрон не зажимает исправить', 'гудит но не работает исправить',
      'быстро разряжается аккумулятор исправить', 'код ошибки исправить'
    ]
  }
];
